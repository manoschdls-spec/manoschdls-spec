...
#### 📉 [Customer Churn Prediction Model](https://github.com/manoschdls-spec/customer-churn-project)
An end-to-end Machine Learning project focused on predicting customer attrition to optimize retention strategies and secure business revenue.
* **Core Tasks:** Advanced data cleaning, feature engineering, handling class imbalance, and predictive modeling.
* **Tech Stack:** Python, Scikit-Learn, Pandas, NumPy.

#### 📊 [Executive Retail Analytics Suite](https://github.com/manoschdls-spec/Retail-Sales-Dashboard)
An enterprise-grade BI dashboard designed for retailers to analyze real-time sales performance, dynamic margins, and product hierarchies. 
* **Core Tasks:** Transforming complex operational data into actionable executive insights and KPI tracking.
* **Tech Stack:** Python, Streamlit, Power BI / Plotly.
